...
fn sign_internal(
    ...
    let canonical = if let Some(peer) = peer_id {
        crate::messages::machine::build_envelope_canonical_with_peer(
            payload,
            payload_type,
            &nonce_owned,
            timestamp,
        ...
        crate::messages::machine::build_envelope_canonical(
            payload,
            payload_type,
            &nonce_owned,
            timestamp,
    ...
    let bytes = if let Some(peer) = peer_id {
        crate::messages::machine::build_envelope_signed_with_peer(
            payload,
            payload_type,
            &nonce_owned,
            timestamp,
        ...
        crate::messages::machine::build_envelope_signed(
            payload,
            payload_type,
            &nonce_owned,
            timestamp,
...
pub fn verify_flatbuffer_envelope_for_peer(
    ...
    let fb_env = crate::messages::machine::root_as_envelope(fb_envelope_bytes)
...
pub fn verify_flatbuffer_envelope_skip_nonce_check(
    ...
    let canonical = crate::messages::machine::build_envelope_canonical(
        &payload_vec,
        payload_type,
        nonce,
        ts,
...
mod tests {
    ...
    fn test_build_and_verify_flatbuffer_envelope_roundtrip() {
        ...
        let fb_canonical = crate::messages::machine::build_envelope_canonical(
            payload,
            payload_type,
            &nonce,
            timestamp,
        ...
        let fb_envelope = crate::messages::machine::build_envelope_signed(
            payload,
            payload_type,
            &nonce,
            timestamp,
