...
pub fn gossipsub_message(
    ...
    if let Ok(cap_req) = crate::protocol::machine::root_as_capacity_request(payload.as_slice()) {
    ...
    if let Ok(cap_reply) = crate::protocol::machine::root_as_capacity_reply(payload.as_slice()) {
