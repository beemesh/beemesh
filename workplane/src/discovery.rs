...
/// ## Fields
///
/// - `workload_id`: Composite key `{namespace}/{workload_name}`
...
pub struct ServiceRecord {
    /// Unique workload identifier: `{namespace}/{workload_name}`.
...
/// # Arguments
///
/// * `workload_id` - The workload identifier (`{namespace}/{workload_name}`)
