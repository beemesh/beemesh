//! # Workload Agent – Main Orchestrator
//!
//! This module implements the core [`Workload`] struct that coordinates all workplane
...
///
/// Create via [`Workload::new`], then call [`Workload::start`] to begin operations.
/// Call [`Workload::close`] for graceful shutdown.
pub struct Workload {
    /// Agent configuration.
    cfg: Config,
